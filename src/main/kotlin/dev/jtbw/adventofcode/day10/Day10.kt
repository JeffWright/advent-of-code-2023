...
import dev.jtbw.adventofcode.util.Direction.Companion.orthogonals
import dev.jtbw.adventofcode.util.Direction.Orthogonal
import dev.jtbw.adventofcode.util.Direction.Orthogonal.*
import dev.jtbw.adventofcode.util.Grid
...
import dev.jtbw.adventofcode.util.minus
import dev.jtbw.adventofcode.util.opposite
import dev.jtbw.adventofcode.util.plus
import dev.jtbw.adventofcode.util.rotate90
import dev.jtbw.adventofcode.util.rotateLeft
import dev.jtbw.adventofcode.util.rotateRight
import dev.jtbw.adventofcode.util.toOrthogonal
